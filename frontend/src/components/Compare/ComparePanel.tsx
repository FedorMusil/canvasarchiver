...
import SectionDiff from '../Section';
                    ...
                    {viewMode !== 'after' && (
                        <ResizablePanel defaultSize={50} id='panel11' order={1}>
                            {/* <div
                                ...
                                ref={oldContentsRef}
                            /> */}
                            {ItemTypes.SECTIONS === prevChange.item_type && <SectionDiff change={prevChange} />}
                        </ResizablePanel>
                    )}
                    ...
                    {viewMode !== 'before' && (
                        <ResizablePanel defaultSize={50} id='panel12' order={2}>
                            {/* <div
                                ...
                                ref={newContentsRef}
                            /> */}
                            {ItemTypes.SECTIONS === changes[changeIdIndex].item_type && <SectionDiff change={changes[changeIdIndex]} />}
                        </ResizablePanel>
                    )}
                </ResizablePanelGroup>
            </ResizablePanel>
