...
import ModuleDiff from '../modules';
                    ...
                    {viewMode !== 'after' && (
                        <ResizablePanel defaultSize={50} id='panel11' order={1}>
                            {/* <div
                                ...
                                ref={oldContentsRef}
                            /> */}
                            {ItemTypes.MODULES === prevChange.item_type && <ModuleDiff change={prevChange} />}
                        </ResizablePanel>
                    )}
                    ...
                    {viewMode !== 'before' && (
                        <ResizablePanel defaultSize={50} id='panel12' order={2}>
                            {/* <div
                                ...
                                ref={newContentsRef}
                            /> */}
                            {ItemTypes.MODULES === changes[changeIdIndex].item_type && <ModuleDiff change={changes[changeIdIndex]} />}
                        </ResizablePanel>
                    )}
                </ResizablePanelGroup>
            </ResizablePanel>
